...
export const DataContextProvider: React.FC = ({ children }) => {
    ...
    const [gifAverageColor, setgifAverageColor] = useState<any>();

    return (
        <DataContext.Provider
            value={{ authUrl: authUrl, musicChanged: musicChanged, setmusicChanged: setmusicChanged, gifAverageColor: gifAverageColor, setgifAverageColor: setgifAverageColor }}
        >
            {children}
        </DataContext.Provider>
    );
